    ...
    <div id="wrapper">
                     ...
                     <li>
                       <a href="#"><i class="fa fa-yelp "></i>收费退费模块 <span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level collapse in">
                            <li>
                                <a  class="active-menu" href="getMoneyInformation.jsp"><i class="fa fa-coffee"></i>收费</a>
                            </li>
                            <li>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">收费信息</h1>	
      				...
      				%>
                                        ...
                                        <td><%=u.getBirth() %></td>
                                            <td> 
                                              ...
                                              <a href="javascript:getMoney(<%=u.getId()%>)" onclick="getMoney(<%=u.getId()%>);" >        	
                                        <button type="button" class="btn btn-success">缴费</button> 
                                        </a> 
