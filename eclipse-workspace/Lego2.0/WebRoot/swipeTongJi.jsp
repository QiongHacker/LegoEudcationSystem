<%@page import="cn.bw.lego.service.tongJiStudentService"%>
...
<body>
    <div id="wrapper">
                    ...
                    <li>
                        ...
                        <a href="#"><i class="fa fa-bicycle "></i>打卡信息统计 <span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level collapse in">
                             ...
                             <li>
                                <a href="swipeTongJi.jsp" class="active-menu"><i class="fa fa-desktop "></i>教师打卡统计 </a>
                            </li>
                             <li>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">教师打卡统计</h1>
                ...
                <div class="col-md-6" style="width: 1200px">
                  <!--   Kitchen Sink -->
                    <div class="panel panel-default">
                       ...
                       <%
               	tongJiStudentService cs = new tongJiStudentService();  
               	List<tongJiStudent> list = cs.getTeachers();
               pageContext.setAttribute("classList",list);
               %>        
                        姓名: <select id="name" style="height: 30px;" >
    ...
    <script type="text/javascript"charset="GBK"  src="js/swipeTeacher.js"></script>
