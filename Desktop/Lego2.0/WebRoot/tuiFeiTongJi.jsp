...
<body>
    <div id="wrapper">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-bicycle "></i>统计报表 <span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level collapse in">
                             ...
                             <li>
                                <a href="tuiFeiTongJi.jsp" class="active-menu"><i class="fa fa-code "></i>退费信息统计</a>
                            </li>
                           <li>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">退费信息统计</h1>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group" style="text-align:center;">
                               ...
                               退费时间: <input type="text" id="startTime" style="height: 30px;" size="10px" value="${startTime}" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true,maxDate:'#F{$dp.$D(\'edate\')}'})"/>
      			...
      			a++;
      				%>
        			      ...
        			      <tr>
        			      	...
        			      	<th><%=u.getTele() %></th>
        			      	<th><%=u.getState() %></th>
        			      	<th><%=u.getReturnprice() %></th>
        			      	<th><%=u.getReturnpricetime() %></th>
        			      	<%} %>
                                 <%} %>
        ...
        <%
      			...
      			for(tongJiStudent u : (List <tongJiStudent>) request.getAttribute("studentList")){
      				...
      				%>
			<h3>合计金额：<%=u.getSumreturnprice() %>元</h3>
                             ...
                             <%
   		List<HashMap<String,Object>> students=tuiFeiTongJiExcelDao.returnMoney();
         String pathString=request.getRealPath("/")+"returnMoney.xls";
     	ExcelUtil3.exportData(students, pathString);
         //ExcelUtil.exportData(students, pathString);
     	out.println("<a href='/Lego2.0/returnMoney.xls'>导出Excel</a>");
      %> 
                            <br>
    ...
    <script type="text/javascript" src="js/tuiFeiTongJi.js"></script> 
    <!-- BOOTSTRAP SCRIPTS -->
