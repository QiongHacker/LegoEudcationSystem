<%@page import="cn.bw.lego.domain.t_student_review"%>
<%@page import="java.util.List"%>
<%@page import="cn.bw.lego.domain.pageBean"%>

<%@page import="cn.bw.lego.dao.StudentReviewDaoImpl"%>
...
<base href="<%=basePath%>">
	...
	<script type="text/javascript" charset="utf-8" src="js/review.js"></script> 
    ...
    <div id="wrapper">
                    ...
                    <li>
                        <a href="#"  class="active-menu-top"><i class="fa fa-desktop "></i>基本信息管理 <span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level collapse in">
                            <li>
                                <a  href="studentInformation.jsp" class="active-menu"></i>学生信息管理</a>
                            </li>
                            <li>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">回访信息管理</h1>
                  ...
                  <!--   Kitchen Sink -->
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                         ...
                         <input type="hidden" id="xm" value="<%=request.getParameter("ID")%>"/>       
                              
                                
                                 
              <button type="button" class="btn btn-success" onclick="review()" >添加回访信息</button>
              <button type="button" class="btn btn-success" onclick="goback()" >返回学生列表</button>
     			...
     			<%
      			...
      			//实例化
     			int a =0;
      			for(t_student_review u : (List <t_student_review>) pagebean.getData()){
      			a++;
      				%>
